...
const QUESTIONS = [
  ...
  { key: 'telefon_raqami', title: '12. Telefon raqami', type: 'text', example: '+998901234567' },
  {
    key: 'ijtimoiy_holati',
    title: '13. Ijtimoiy holati',
    type: 'choice',
    options: ['Yaxshi', 'Temir daftar', 'Nogironligi bor', "Boquvchisi yo'q", 'Chin yetim', OTHER_TEXT],
    allowOther: true,
  },
